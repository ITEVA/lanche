        ...
        <div class="col-md-12">
            <div class="col-middle">
                <div class="text-center text-center">
                    ...
                    <h2>Desculpe, mas não encontramos esta página</h2>
                    <p>A página procurada não existe ou você não possui permissão para acessá-la.
                    </p>
                    <a href="/home" style="color: #FFFFFF">Voltar para o início.</a>
                </div>
            </div>
        </div>
        <!-- /page content -->
