...
<div class="">
    <div class="row conteudoPrincipal">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <a href="cardapios/removerLote" id="removerLote" class="btn btn-success pull-right">
                    <i class="fa fa-trash"></i>&nbsp;Remover
                </a>
                <a href="cardapios/editarLote" id="editarLote" class="btn btn-success pull-right">
