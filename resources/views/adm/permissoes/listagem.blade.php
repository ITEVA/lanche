...
<div class="">
    <div class="row conteudoPrincipal">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <a href="permissoes/removerLote" id="removerLote" class="btn btn-success pull-right">
                    <i class="fa fa-trash"></i>&nbsp;Remover
                </a>
                <a href="permissoes/novo" class="btn btn-success pull-right">
                    <i class="fa fa-plus"></i>&nbsp;Novo
                </a>

                <div class="x_title">
                    <h2>Permissões cadastradas no sistema</h2>
                        ...
                        @if(count($permissoes) > 0)
                            @foreach($permissoes as $permissao)
                                <tr class="even pointer">
                                    <td class="a-center ">
                                        <input type="checkbox" id="row{{$permissao->id}}" class="tableflat">
                                    </td>
                                    <td>{{$permissao->nome}}</td>
                                    <td>{{$permissao->descricao}}</td>
                                    <td class="iconeListagem"><a
                                                href="permissoes/editar/{{$permissao->id}}"><i
