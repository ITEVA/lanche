                ...
                <div class="x_content">
                    ...
                    <form method="POST" action="{{$action}}" enctype="multipart/form-data" id="demo-form"
                        ...
                        <div class="form-group col-md-12 col-xs-12">
                            ...
                            <span class="quebraBox">
                                <input type="checkbox" class="permissao" value="cargo" name="cargo" {{isset($permissoesAtuais['cargo']) ? 'checked' : ''}}><label class="lblPermissao">Cargos</label>
                            </span>
                            <span class="quebraBox">
                            ...
                            <span class="quebraBox">
                                <input type="checkbox" class="permissao" value="almoco" name="almoco" {{isset($permissoesAtuais['almoco']) ? 'checked' : ''}}><label class="lblPermissao">Almoço</label>
                            </span>
                            <span class="quebraBox">
