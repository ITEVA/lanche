...
<div class="">
    <div class="row conteudoPrincipal">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <a href="almocos/removerLote" id="removerLote" class="btn btn-success pull-right">
                ...
                <div class="x_content">
                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                        ...
                        @if(count($almocos) > 0)
                            @foreach($almocos as $almoco)
                                <tr class="even pointer">
                                    <td class="a-center ">
                                        <input type="checkbox" id="row{{$almoco->id}}" class="tableflat">
                                    </td>
                                    <td>{{$almoco->data}}</td>
                                    <td class="iconeListagem"><a
                                                href="almocos/editar/{{$almoco->id}}"><i
                        ...
                        @else
                            <tr>
                                <td colspan="5" class="iconeListagem">Nenhum almoço encontrado</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
