...
@section('css')
    <link href="adm/css/acompanhamento.css" rel="stylesheet">
    ...
    <div class="row conteudoPrincipal">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form method="POST" action="relatorios/acompanhamento" enctype="multipart/form-data" id="filtro" data-parsley-validate>
                        ...
                        @if(count($pedidos) > 0)
                            @foreach($pedidos as $pedido)
                                <tr class="even pointer">
                                    ...
                                    <td>{{$pedido['nomeUsuario'][0]['apelido']}}</td>
                                    <td>
                                        <ul>
                                        @foreach($pedido['produtos'] as $produtoPedido)
                                            <li>{{$produtoPedido['nome_formado']}}: {{str_replace(".", ",", $produtoPedido['quantidade'])}}</li>
                                        @endforeach
                                        </ul>
                                    </td>
