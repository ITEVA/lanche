...
$tinybrowser['path']['image'] = '/uploads/imagens/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads/midia/'; // Media files location
$tinybrowser['path']['file']  = '/uploads/arquivos/'; // Other files location
